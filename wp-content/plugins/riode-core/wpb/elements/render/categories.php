...
$wrapper_attrs = array(
	'class' => 'riode-wpb-categories-container ' . $shortcode_class . $style_class,
);
...
if ( empty( $atts['content_origin'] ) ) {
	$atts['content_origin'] = '';
}
if ( empty( $atts['col_sp'] ) ) {
	$atts['col_sp'] = '';
}
if ( ! isset( $atts['category_type'] ) ) {
	$atts['category_type'] = '';
}
...
$atts = array_merge(
	...
	array(
		...
		'subcat_cnt'            => isset( $atts['subcat_cnt'] ) ? $atts['subcat_cnt'] : '',
