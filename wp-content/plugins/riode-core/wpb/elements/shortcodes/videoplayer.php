...
$params = array(
	esc_html__( 'Style', 'riode-core' ) => array(
		array(
			'type'        => 'iconpicker',
			'heading'     => esc_html__( 'Player Icon', 'riode-core' ),
			'param_name'  => 'button_icon',
			'std'         => 'd-icon-play-solid',
			'description' => esc_html__( 'Choose icon from icon library that will be video player.', 'riode-core' ),
		),
		array(
			'type'        => 'riode_number',
		...
		array(
			...
			'description' => esc_html__( 'Choose from Default, Square, Rounded, Ellipse.', 'riode-core' ),
...
vc_map(
	array(
		'name'            => esc_html__( 'Video Player', 'riode-core' ),
		'base'            => 'wpb_riode_videoplayer',
		'icon'            => 'riode-logo-icon',
		'class'           => 'riode_videoplayer',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => esc_html__( 'Riode', 'riode-core' ),
		'description'     => esc_html__( 'Plays video in banner', 'riode-core' ),
		'as_child'        => array( 'only' => 'wpb_riode_banner_layer' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_WPB_Riode_Videoplayer extends WPBakeryShortCode {
