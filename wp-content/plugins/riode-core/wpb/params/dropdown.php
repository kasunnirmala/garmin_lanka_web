...
function riode_dropdown_callback( $settings, $value ) {
	...
	$html .= '<select class="riode-wpb-dropdown' . ( $is_responsive ? '' : ' simple-value' ) . '" data-xl="' . ( isset( $responsive_value['xl'] ) ? esc_html( $responsive_value['xl'] ) : '' ) . '"
...
vc_add_shortcode_param( 'riode_dropdown', 'riode_dropdown_callback', plugins_url( '../js/riode-dropdown.js', __FILE__ ) );
