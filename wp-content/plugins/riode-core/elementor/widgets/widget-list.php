 ...
 * Riode List Widget
 *
 * Riode Widget to display custom list.
 *
 * @since 1.0
 */
...
class Riode_List_Elementor_Widget extends \Elementor\Widget_Icon_List {

	public function get_name() {
		return 'riode_widget_list';
	}

	public function get_title() {
		return esc_html__( 'List', 'riode-core' );
	}

	public function get_icon() {
		return 'riode-elementor-widget-icon widget-icon-list';
	}
	...
	public function get_keywords() {
		return array( 'list', 'list-item', 'icon' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_ordered',
			[
				'label' => __( 'Ordered List', 'elementor' ),
			]
		);
		$this->add_control(
			'ordered_list',
		...
		$this->add_control(
			'list_style',
			[
				'label'       => __( 'List Style', 'elementor' ),
				'description' => esc_html__( 'Select a certain list style for your ordered list.', 'riode-core' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => [
					'none'                 => __( 'None', 'elementor' ),
					'circle'               => __( 'Circle', 'elementor' ),
					'decimal'              => __( 'Decimal', 'elementor' ),
					'decimal-leading-zero' => __( 'Decimal Leading Zero', 'elementor' ),
					'lower-alpha'          => __( 'Lower-alpha', 'elementor' ),
					'upper-alpha'          => __( 'Upper-alpha', 'elementor' ),
					'disc'                 => __( 'Disc', 'elementor' ),
	...
	protected function render() {
		...
		include RIODE_CORE_PATH . 'elementor/render/widget-list-render.php';
	}
