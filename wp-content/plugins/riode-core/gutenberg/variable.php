...
if ( function_exists( 'riode_get_layout_value' ) && 'container' == riode_get_layout_value( 'general', 'wrap' ) ) {
	echo '.is-root-container {
...
} elseif ( function_exists( 'riode_get_layout_value' ) && 'container_fluid' == riode_get_layout_value( 'general', 'wrap' ) ) {
	echo '.is-root-container {
		padding: 0 2rem;
