...
class Riode_RestAPI {
	...
	public function register_RestAPI() {
		...
		include_once RIODE_CORE_PATH . '/gutenberg/rest/class_products_controller.php';
		$controller = new Riode_Rest_Products_Controller();
	...
	function add_post_author( $object ) {
		return riode_strip_script_tags( get_the_author_meta( 'display_name' ) );
	}
