...
echo '<div id="riode_gtnbg_button_' . $id . '" class="' . esc_attr( $className ) . '">';
echo '<style>';

echo '#riode_gtnbg_button_' . $id . '{' . $block_style . '}';
echo '#riode_gtnbg_button_' . $id . ' .btn{' . $b_style . '}';
echo '#riode_gtnbg_button_' . $id . ' .btn:hover{' . $hover_style . '}';
echo '#riode_gtnbg_button_' . $id . ' .btn i{' . $i_style . '}';
