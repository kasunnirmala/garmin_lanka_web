...
class Riode_Products_Sidebar_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'products-widget', esc_html__( 'RIODE - Products', 'riode-core' ), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		wc_set_loop_prop( 'content_align', 'left' );
