<?php
/**
 * Riode Header Elementor Language Switcher
 */
defined( 'ABSPATH' ) || die;
...
class Riode_Header_Language_Switcher_Elementor_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'riode_header_language_switcher';
	}

	public function get_title() {
		return esc_html__( 'Language Switcher', 'riode-core' );
	}

	public function get_icon() {
		return 'riode-elementor-widget-icon fas fa-language';
	}
	...
	public function get_keywords() {
		return array( 'header', 'switcher', 'language', 'riode', 'multi', 'translate' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_item_style',
			array(
				'label' => esc_html__( 'Language item', 'riode-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
