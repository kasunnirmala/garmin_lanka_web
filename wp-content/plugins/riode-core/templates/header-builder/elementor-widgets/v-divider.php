<?php
/**
 * Riode Header Elementor Vertical Divider
 */
defined( 'ABSPATH' ) || die;
...
class Riode_Header_V_Divider_Elementor_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'riode_header_v_divider';
	}

	public function get_title() {
		return esc_html__( 'Vertical Divider', 'riode-core' );
	}

	public function get_icon() {
		return 'riode-elementor-widget-icon eicon-vertical-divider';
	}
	...
	public function get_keywords() {
		return array( 'riode', 'header', 'divider', 'spacing', 'vertical', 'line' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Vertical Divider', 'riode-core' ),
