...
// Preprocess
$wrapper_attrs = array(
	'class' => 'riode-hb-wishlist-container ' . $shortcode_class . $style_class,
);
...
$args = array(
	...
	'icon'         => isset( $atts['icon'] ) && $atts['icon'] ? $atts['icon'] : 'd-icon-heart',
	'label'        => isset( $atts['label'] ) ? $atts['label'] : 'Wishlist',
