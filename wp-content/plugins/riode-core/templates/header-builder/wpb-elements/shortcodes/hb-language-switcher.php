...
vc_map(
	array(
		'name'            => esc_html__( 'Header Language Switcher', 'riode-core' ),
		'base'            => 'wpb_riode_hb_language_switcher',
		'icon'            => 'riode-logo-icon',
		'class'           => 'riode_hb_language_switcher',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => esc_html__( 'Riode Header', 'riode-core' ),
		'description'     => esc_html__( 'Language switcher plugin menu or item', 'riode-core' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_WPB_Riode_HB_Language_Switcher extends WPBakeryShortCode {
	}
}
