...
<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
	...
	<div class="form-row input-wrapper-inline form-coupon">
		...
		<button type="submit" class="btn btn-outline btn-dark button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
	</div>
